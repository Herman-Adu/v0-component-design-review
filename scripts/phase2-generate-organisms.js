...
console.log(\`  Atoms:     7  (StatusBadge, CategoryBadge, IconContainer, SectionHeading, SpecRow, ChecklistRow, MetricValue)\`)
console.log(\`  Molecules: 7  (PlatformHeader, BackNavigationCard, WhyPlatformCard, StrategyPhaseCard, ToolCard, ReportingCadenceCard, ContentComparisonTable)\`)
console.log(\`  Organisms: 5  (ToolGrid, StrategyFlow, MetricsGrid, ChecklistCard, PlatformSpecsCard)\`)
