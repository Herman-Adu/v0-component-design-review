...
export interface ApiAppReferenceAppReference
  ...
  info: {
    description: 'Documentation: application features, components, and API reference';
    displayName: 'App Reference';
    pluralName: 'app-references';
    singularName: 'app-reference';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    access: Schema.Attribute.Component<'shared.access', false>;
    blocks: Schema.Attribute.DynamicZone<
      [
        'atom.paragraph',
        'molecule.info-box',
        'molecule.section-header',
        'molecule.sub-section-header',
        'molecule.code-block',
        'molecule.key-takeaway',
        'organism.metrics-grid',
        'organism.feature-grid',
        'organism.comparison-cards',
        'organism.process-flow',
        'organism.step-flow',
        'organism.stats-table',
        'organism.related-articles',
        'organism.architecture-diagram',
        'organism.file-tree',
        'organism.decision-tree',
        'organism.data-flow-diagram',
        'organism.vertical-flow',
        'organism.before-after-comparison',
      ]
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    meta: Schema.Attribute.Component<'shared.meta', false> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    route: Schema.Attribute.Component<'shared.route', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    sourceMarkdown: Schema.Attribute.RichText;
    toc: Schema.Attribute.Component<'shared.toc-item', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content library articles with atomic blocks';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content library case studies with atomic blocks';
...
export interface ApiCmsReferenceCmsReference
  extends Struct.CollectionTypeSchema {
  collectionName: 'cms_references';
  info: {
    description: 'Documentation: Strapi schema docs, block definitions, content governance';
    displayName: 'CMS Reference';
    pluralName: 'cms-references';
    singularName: 'cms-reference';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGuideGuide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content library guides with atomic blocks';
    displayName: 'Guide';
    pluralName: 'guides';
    singularName: 'guide';
  };
...
export interface ApiInfrastructureOpsInfrastructureOps
  extends Struct.CollectionTypeSchema {
  collectionName: 'infrastructure_ops';
  info: {
    description: 'Documentation: Docker, CI/CD, deployment, operations runbooks';
    displayName: 'Infrastructure Ops';
    pluralName: 'infrastructure-ops-docs';
    singularName: 'infrastructure-ops';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiStrategicOverviewStrategicOverview
  ...
  info: {
    description: 'Documentation: high-level system vision, roadmap, architectural decisions';
    displayName: 'Strategic Overview';
    pluralName: 'strategic-overviews';
    singularName: 'strategic-overview';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTutorialTutorial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content library tutorials with atomic blocks';
