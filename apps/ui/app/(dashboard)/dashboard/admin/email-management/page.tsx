...
function resolveIcon(name: string): LucideIcon {
  ...
  return typeof icon === "function" ? (icon as LucideIcon) : Icons.Mail;
}
...
function buildFallbackVM(): EmailManagementVM {
  const raw = emailAdminData as {
...
export default async function EmailManagementOverviewPage() {
  const vm = (await getEmailManagement()) ?? buildFallbackVM();
