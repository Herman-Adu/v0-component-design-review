 ...
 *
 * Defines the structure for infrastructure and operations documentation pages.
...
const InfrastructureOpsMetaSchema = DocumentationMetaBaseSchema.extend({
  category: z.literal("infrastructure-ops"),
});
...
export const InfrastructureOpsDocumentSchema = z.object({
  meta: InfrastructureOpsMetaSchema,
...
>;
export type InfrastructureOpsMeta = z.infer<typeof InfrastructureOpsMetaSchema>;
export type InfrastructureOpsBlock = z.infer<typeof blockSchema>;
export type InfrastructureOpsTocItem = z.infer<typeof TocItemSchema>;
export type InfrastructureOpsCategory = "infrastructure-ops";
